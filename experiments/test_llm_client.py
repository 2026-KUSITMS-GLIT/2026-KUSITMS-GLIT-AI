...
async def main() -> None:
    ...
    try:
        ...
        logger.info("응답", extra={"text": response.content[0].text, "input_tokens": response.usage.input_tokens, "output_tokens": response.usage.output_tokens})  # type: ignore[union-attr]
